...
(function () {
    ...
    /* ------------------------------------------------------------------ */
    /* Broadcast data — loaded from the single source of truth            */
    /* (data/schedule.js -> window.NEON_SCHEDULE_DATA), so the homepage   */
    /* widget and this page can never disagree.                           */
    /* ------------------------------------------------------------------ */
    var SCHEDULE = Array.isArray(window.NEON_SCHEDULE_DATA)
        ? window.NEON_SCHEDULE_DATA.slice()
        : [];
