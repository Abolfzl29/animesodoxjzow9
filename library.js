...
(function () {
    ...
    function initSharedChrome() {
        toastContainer();
        markActiveLinks();
        // Side-menu wiring is intentionally omitted here. script.js is the single
        // owner of the mobile drawer (hamburger / backdrop / close / links / VIP /
        // Escape) and is loaded on every page that calls initSharedChrome(). Binding
        // it again below registered a second click handler on the hamburger that
        // cancelled the first one, so the drawer never opened on library pages.
    }
